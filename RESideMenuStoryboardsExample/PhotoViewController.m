...
- (void)viewDidLoad
{
	...
	NSString *filePath2 = [documentsDirectory stringByAppendingPathComponent:jFilenamedejalues];
	// on cherche un fichier de données pour le rootViewController
	//il y a un fichier
...
- (void) afficher{
	...
	// start the parser
    fluxAparser=NSLocalizedString(@"PhotoFeed", @"rss des photos");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *descript = [dictio objectForKey:@"description"];
